...
def CreateForm(request, template='forms/createform.html'):
    return render(request, template)

def FormData(request, template='forms/formdata.html'):
    # data = FormManager.objects.all()
    # data2 = AbstractForm.objects.all()
    # data3 = FieldManager.objects.all()
    # data4 = AbstractField.objects.all()
    # data5 = AbstractFormEntry.objects.all()
    # data6 = AbstractFieldEntry.objects.all()

    data7 = FormEntry.objects.all()
    data8 = FieldEntry.objects.all()
    data9 = Form.objects.all()
    data0 = Field.objects.all()
    return render(request, {'data7':data7,'data8':data8,'data9':data9,'data0':data0,})

class listviewss(ListView):
    model = FieldEntry
    template_name = 'forms/formdata.html'
    def get_context_data(self, **kwargs):
