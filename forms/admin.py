...
from .models import Form, Field, FormEntry, FieldEntry, Field_Test
...
class FieldAdmin1(admin.TabularInline):
    model = Field_Test
    exclude = ('slug', )
...
class FormAdmin(admin.ModelAdmin):
    ...
    inlines = (FieldAdmin,FieldAdmin1)
